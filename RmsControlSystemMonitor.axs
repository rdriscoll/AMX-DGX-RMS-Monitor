 ...
 *     as applicable.
*/
MODULE_NAME='RmsControlSystemMonitor'(DEV vdvRMS, DEV dvMonitoredDevice)
...
DEFINE_FUNCTION RegisterAsset(RmsAsset asset)
{
  ...
  // the RMS Client will automatiaclly register the
...
assetClientKey = RmsDevToString(dvMonitoredDevice);
